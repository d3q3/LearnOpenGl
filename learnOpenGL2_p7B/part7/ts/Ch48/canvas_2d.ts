...
// letter positions
// px-is pixels in sceen space; Point-is units in World space
let pxA: vec2, PointA: vec4;
let pxB: vec2, PointB: vec4;
let pxC: vec2, PointC: vec4;
let pxD: vec2, PointD: vec4;
let pxE: vec2, PointE: vec4;
let pxF: vec2, PointF: vec4;
let dwChar;
...
let main = function () {
    ...
    // dwChar for corrections on left and right positions of letters
...
function render() {
    ...
    // render the text in the canvasOverlay
