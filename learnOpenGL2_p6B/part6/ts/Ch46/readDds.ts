//D3Q:  From https://github.com/toji/webgl-texture-utils/blob/master/texture-util/dds.js
...
//D3Q: removed define: we only use javascript modules
//This is a selection of the original code
//Some of the code has as author Evan Parker.
 ...
 */
function uploadDDSLevels(gl: WebGL2RenderingContext, ext, arrayBuffer, loadMipmaps) {
    ...
    if (header[off_magic] != DDS_MAGIC) {
        ...
        //D3Q: changed return value
        return { mipmaps: 0, width: 0, height: 0 }
        //return 0;
    }

    //D3Q: added parenthesis ( and ).
...
//D3Q: the return names are the functions that are exported 
// return {
