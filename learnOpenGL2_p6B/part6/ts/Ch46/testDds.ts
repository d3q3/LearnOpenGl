...
/**
 * D3Q: test Dds reader in readDds.ts
 * 
 * D3Q: adapted from test by Brandon Jones
 * see https://github.com/toji/webgl-texture-utils/blob/master/texture-util/dds.js
 * 
 * D3Q: Brandon uses a loader for all kinds of image-types, uses a different shader-class and
 * a different matrix class. But the general idea of this code can be found in his file test.html.
 */
...
let main = function () {
    ...
    for (i = 0, l = textureSet.length; i < l; ++i) {
        textures.push(
            loadDDSTexture(gl, extS3tc, textureSet[i].src, function (texture, width, height, mipmaps) {
