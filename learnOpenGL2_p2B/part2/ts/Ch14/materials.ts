import { vs_materials, fs_materials, vs_lamp, fs_lamp } from "../../js/Ch14/shaders/index.js";
...
function render() {
    ...
    //gl.uniformMatrix4fv(gl.getUniformLocation(lightingShader.programId, "projection"), false, projection);
    //lightingShader.setMat4("view", view);
    //gl.uniformMatrix4fv(gl.getUniformLocation(lightingShader.programId, "view"), false, view);
    setMat4vShader(lightingShader, "view", view);
    // world transformation
    let model: mat4 = mat4.create();
    setMat4vShader(lightingShader, "model", model);
    //gl.uniformMatrix4fv(gl.getUniformLocation(lightingShader.programId, "model"), false, model);
    ...
    model = mat4.scale(model, model, vec3.fromValues(0.2, 0.2, 0.2)); // a smaller cube
